...
@php
    ...
    $icons = [
        ...
        'plus' => 'M12 4v16m8-8H4',
        'mail' => 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-18 8h18a2 2 0 002-2V8a2 2 0 00-2-2H3a2 2 0 00-2 2v6a2 2 0 002 2z',
    ];
    $path = $icons[$icon] ?? $icons['home'];
@endphp

<a href="{{ route($route) }}"
   class="flex items-center px-4 py-2.5 text-sm transition-colors {{ $isActive ? 'bg-gray-800 text-white border-r-2 border-blue-500' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
